...
var (
	...
	pathToUnixSocket = flag.String("path-to-unix-socket", "/tmp/socket.sock", "Full path to Unix socket that is used for communicating with KubeAPI Server, or Linux socket namespace object - must start with @")
